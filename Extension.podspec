...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shore-frank/Extension'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shore-frank' => 'yi@shore.network' }
  s.source           = { :git => 'https://github.com/shore-frank/Extension.git', :tag => s.version.to_s }
